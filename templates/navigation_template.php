...
*
* Navigation Template for bootstrap5
*/

/* it should be templated this way:
- main........horizontal with dropdown   	and ul/li/a version, ul.navbar-nav + li.nav-item + a.nav-link  ul/li/a dropdown
- main-alt....horizontal with dropdown   	and div/a version, div.navbar-nav + a.nav-link div/a dropdown
...
- alt-alt.....vertical   with flex-column   and nav/a version, nav.nav.flex-column + li.nav-item + a.nav-link
- alt5........horizontal with dropdown   	and nav/a version, nav.nav  + a.nav-item.nav-link
*/

/* main diffs:  
	- data-bs-toggle changed to bs-data-bs-toggle 
	- dropdown markup only ul/li/a support
	- dropdown parent url has to #, not link with # or any link
	- aria-current attr for active item in navbar
*/

/* to check: active for a not li */

// TEMPLATE FOR {NAVIGATION=main}
// https://getbootstrap.com/docs/5.0/components/navbar/

$NAVIGATION_TEMPLATE['main']['start'] = "<ul class='navbar-nav me-auto mb-2 mb-lg-0 {NAV_CLASS}' >";    
$NAVIGATION_TEMPLATE['main']['item'] = "<li class='nav-item'><a class='nav-link' href='{NAV_LINK_URL}' {NAV_LINK_OPEN} title='{NAV_LINK_DESCRIPTION}'>{NAV_LINK_ICON}{NAV_LINK_NAME}</a></li>";
$NAVIGATION_TEMPLATE['main']['item_active'] = "<li class='nav-item'><a class='nav-link active' aria-current='true' href='{NAV_LINK_URL}' title='{NAV_LINK_DESCRIPTION}'>{NAV_LINK_ICON}{NAV_LINK_NAME}</a></li>";
$NAVIGATION_TEMPLATE['main']['end'] = '</ul>';

// Main Link which has a sub menu. 
$NAVIGATION_TEMPLATE['main']['item_submenu'] = "
	<li class='nav-item dropdown'>
		<a class='nav-link dropdown-toggle' aria-current='true' role='button' data-bs-toggle='dropdown' id='navbarDropdownMenuLink-{NAV_LINK_ID}' data-target='#' aria-haspopup='true' aria-expanded='false' href='#' title='{NAV_LINK_DESCRIPTION}'>
...
$NAVIGATION_TEMPLATE['main']['item_submenu_active'] = '
	<li class="nav-item dropdown {NAV_LINK_IDENTIFIER}">
		<a class="nav-link active dropdown-toggle" aria-current="true"  role="button" data-bs-toggle="dropdown" id="navbarDropdownMenuLink-{NAV_LINK_ID}" aria-haspopup="true" aria-expanded="true" data-target="#" href="#">
		 {NAV_LINK_ICON}{NAV_LINK_NAME}
		</a>
		{NAV_LINK_SUB}
	</li>
...
$NAVIGATION_TEMPLATE['main']['submenu_start'] = '<ul class="dropdown-menu submenu-start submenu-level-{NAV_LINK_DEPTH}" aria-labelledby="navbarDropdownMenuLink-{NAV_LINK_PARENT}">';
$NAVIGATION_TEMPLATE['main']['submenu_item'] = '<li><a class="dropdown-item" href="{NAV_LINK_URL}" {NAV_LINK_OPEN}>{NAV_LINK_ICON}{NAV_LINK_NAME}</a></li>';
$NAVIGATION_TEMPLATE['main']['submenu_item_active'] = '<li><a class="dropdown-item active" href="{NAV_LINK_URL}" {NAV_LINK_OPEN}>{NAV_LINK_ICON}{NAV_LINK_NAME}</a></li>';
...
$NAVIGATION_TEMPLATE['main-alt'] = $NAVIGATION_TEMPLATE['main'];
...
$NAVIGATION_TEMPLATE['main-alt']['item_active'] = "<a class='nav-link active' href='{NAV_LINK_URL}' {NAV_LINK_OPEN} title='{NAV_LINK_DESCRIPTION}'>{NAV_LINK_ICON}{NAV_LINK-NAME}</a>";
...
$NAVIGATION_TEMPLATE['side']['item_submenu_active'] = "<li>{NAV_LINK_ICON}{NAV_LINK_NAME}{NAV_LINK_SUB}</li>"; 				
...
$NAVIGATION_TEMPLATE['footer']['item_active'] 			= "<li class='nav-item' {NAV_LINK_OPEN}>
	<a class='nav-link active' href='{NAV_LINK_URL}' title='{NAV_LINK_DESCRIPTION}'>{NAV_LINK_ICON}{NAV_LINK_NAME}</a></li>";
$NAVIGATION_TEMPLATE['footer']['end'] 					= '</ul>';

$NAVIGATION_TEMPLATE['footer']['item_submenu'] 			= "
<li class='nav-item dropdown'>
	<a class='nav-link dropdown-toggle'  role='button' data-bs-toggle='dropdown' data-target='#' aria-haspopup='true' 
...
<li class='nav-item dropdown'>
	<a class='nav-link active dropdown-toggle'  role='button' data-bs-toggle='dropdown' data-target='#' aria-haspopup='true' aria-expanded='false' href='#' title='{NAV_LINK_DESCRIPTION}'>
	 {NAV_LINK_ICON}{NAV_LINK_NAME} 
	</a> 
	{NAV_LINK_SUB}
</li>";
$NAVIGATION_TEMPLATE['footer']['submenu_start'] 		= "<ul class='dropdown-menu'>";
$NAVIGATION_TEMPLATE['footer']['submenu_item']			= "<li><a class='dropdown-item' href='{NAV_LINK_URL}' {NAV_LINK_OPEN} title='{NAV_LINK_DESCRIPTION}'>{NAV_LINK_ICON}{NAV_LINK_NAME}</a></li>";
$NAVIGATION_TEMPLATE['footer']['submenu_item_active'] 	= "<li><a class='dropdown-item active' href='{NAV_LINK_URL}' {NAV_LINK_OPEN} title='{NAV_LINK_DESCRIPTION}'>{NAV_LINK_ICON}{NAV_LINK_NAME}</a></li>";
...
/* 
 ...
 see https://getbootstrap.com/docs/5.0/components/navs-tabs/#vertical
*/ 
