...
// ------------------ media-list -----------------
	...
	<div class="d-flex py-3">
		{NEWS_IMAGE: type=tag&class=d-flex me-3&placeholder=1}			 
	...
	$NEWS_GRID_TEMPLATE['footer-media-list']['featured'] = $NEWS_GRID_TEMPLATE['footer-media-list']['item'];


	$NEWS_GRID_TEMPLATE['footer-media-list']['end'] = '</div>';
